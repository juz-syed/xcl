                    ...
                    <ul class="sf-menu" id="menu">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                      ...
                                      <div class="img-hover">
                                         ...
                                         <div class="overlay"><a href="teams.php">+</a></div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                      ...
                                      <div class="img-hover">
                                         ...
                                         <div class="overlay"><a href="players.php">+</a></div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                      ...
                                      <div class="img-hover">
                                         ...
                                         <div class="overlay"><a href="results.php">+</a></div>
                                      </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="current">
                            ...
                            <ul class="sub-current">
                                <li>
                                    <a href="teams.php">Teams List</a>
                                </li>
                                <li>
                                    <a href="single-team.php">Single Team</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="current">
                            ...
                            <ul class="sub-current">
                                <li>
                                    <a href="players.php">Players List</a>
                                </li>
                                <li>
