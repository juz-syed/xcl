            ...
            <div id="mobile-nav">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="results.php">Results List</a>
                            </li>
                            <li>
                        ...
                        <div class="col-md-4">
                            <aside class="panel-box">
                                ...
                                <div class="info-panel">
                                    <address>
                                      <strong>Orka Sports Ltd.</strong><br>
                                      <i class="fa fa-map-marker"></i><strong>Address: </strong> 1309 Coffeen Avenue STE 1200,<br>
                                      <i class="fa fa-plane"></i><strong>City: </strong>Sheridan, Wyoming 82801, United States<br>
                                      <i class="fa fa-phone"></i> <abbr title="Phone">P:</abbr> (+1)
                                    </address>
                                </div>
                            </aside>
                            ...
                            <aside class="panel-box">
                                ...
                                <div class="info-panel">
                                    <address>
                                      <i class="fa fa-envelope"></i><strong>Email:</strong><a href="mailto:#"> info@xclt20.com</a><br>
                                      <i class="fa fa-envelope"></i><strong>Email:</strong><a href="mailto:#"> xclt20.com@gmail.com</a>
                                    </address>
                                </div>
                            </aside>
                        </div>
